...
2. Download the plugin. There are two supported ways:
   * Downloading the latest archive file from the GitHub project page:
       wget https://github.com/rkallensee/redmine-google-analytics-plugin/archive/master.zip
   * Checkout the sources from Git:
       git clone git://github.com/rkallensee/redmine-google-analytics-plugin.git plugins/google_analytics_plugin
